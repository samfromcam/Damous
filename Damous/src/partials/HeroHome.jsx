    ...
    <section>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative">
        ...
        <div className="relative pt-32 pb-10 md:pt-40 md:pb-16">
          {/* Section header */}
          <div className="max-w-3xl mx-auto text-center sm:text-left pb-12 md:pb-16">
            <h1 className="h1 mb-4" data-aos="fade-up">
              Unlock the Power of Data for Your Business
            </h1>
            <p className="text-xl text-gray-400 mb-8" data-aos="fade-up" data-aos-delay="200">
              In today's data-driven economy, obtaining and curating customized datasets can be time-consuming. Our service helps you save time, labor, and money by providing clean, tailored datasets, allowing you to focus on development stages.
            </p>
